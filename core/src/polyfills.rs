...
/// bytes that have been filled and whether the unfilled region was initialized.
///
...
pub struct BorrowedBuf<'data> {
    ...
    filled: usize,
    /// Whether the entire unfilled part of `self.buf` has explicitly been
    /// initialized.
    init: bool,
}
...
impl<'a> BorrowedCursor<'a> {
    ...
    /// # Safety
    ///
    /// The caller must not uninitialize any bytes of the cursor if it is
    /// initialized.
    #[inline]
...
impl<'a> io::Write for BorrowedCursor<'a> {
    #[inline]
