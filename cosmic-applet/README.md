...
When you want a global shortcut to open the clipboard history you can register a custom global shortcut in the Cosmic Settings app. Set the command to `ringboard-cosmic-applet` and assign your desired keybinding.
